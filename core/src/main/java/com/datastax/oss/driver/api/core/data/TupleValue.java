...
public interface TupleValue extends GettableByIndex, SettableByIndex<TupleValue> {
  ...
  /**
   * Returns an abstract representation of this object, <b>that does not include the tuple's
   * contents</b>.
   *
   * <p>This returns the default format of {@link Object#toString()}: the class name, followed by
   * the at-sign and the hash code of the object.
   *
